export const womanBook = `
    No princípio da noite, após a maçante aula de Semiótica, Pedro voou até a Cafeteria Realejo. A chuva forte, a ventania, as ruas escuras e desertas, nada o desestimulou. Chegou ensopado, ofegante, os óculos de grau embaçados, os books bem preservados na surrada maleta de couro. Escolheu a mesa de sempre — a mais próxima do balcão.
	...
	Quando a viu se afastar, Pedro retirou do malote Cem Anos de Solidão, de Gabriel Garcia Márquez. Ao examinar, pareceu-lhe o título um mau agouro. Pôs-se a fingir que lia o book. Não tirava os olhos dela, disfarçava mal, nem ao menos fechava a boca enquanto a acompanhava saracoteando.
